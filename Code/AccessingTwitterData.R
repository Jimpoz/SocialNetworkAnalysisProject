...
#prima raccolta ha ritornato pochi valori a causa di un errore
data_frame_1_27112022 <- rtweet::search_tweets("Just Stop Oil OR just stop oil", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_1_27112022, "data_frame_1_27112022.xlsx")
...
#29112022
data_frame_29112022 <- rtweet::search_tweets("attivisti OR Attivisti", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_29112022, "data_frame_29112022.xlsx")

data_frame_1_29112022 <- rtweet::search_tweets("Ambientalisti OR ambientalisti OR crisi climatica", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_1_29112022, "data_frame_1_29112022.xlsx")

data_frame_2_29112022 <- rtweet::search_tweets("Just stop oil OR just stop oil", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_2_29112022, "data_frame_2_29112022.xlsx")

data_frame_3_29112022 <- rtweet::search_tweets("Climate activists OR climate activists", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_3_29112022, "data_frame_3_29112022.xlsx")

#30112022
data_frame_30112022 <- rtweet::search_tweets("attivisti OR Attivisti", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_30112022, "data_frame_30112022.xlsx")

data_frame_1_30112022 <- rtweet::search_tweets("ambientalisti OR Ambientalisti", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_1_30112022, "data_frame_1_30112022.xlsx")

data_frame_2_30112022 <- rtweet::search_tweets("Crisi climatica", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_2_30112022, "data_frame_2_30112022.xlsx")

data_frame_3_30112022 <- rtweet::search_tweets("Just Stop Oil OR just stop oil", n = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_3_30112022, "data_frame_3_30112022.xlsx")

#01122022
data_frame_01122022 <- rtweet::search_tweets("climate crisis OR climate activists", n  = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_01122022, "data_frame_01122022.xlsx")

data_frame_1_01122022 <- rtweet::search_tweets("Just Stop Oil OR just stop oil", n  = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_1_01122022, "data_frame_1_01122022.xlsx")

#02122022
data_frame_02122022 <- rtweet::search_tweets("Crisi climatica", n  = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_02122022, "data_frame_02122022.xlsx")

data_frame_1_02122022 <- rtweet::search_tweets("Just Stop Oil OR just stop oil OR climate activists", n  = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_1_02122022, "data_frame_1_02122022.xlsx")

data_frame_2_02122022 <- rtweet::search_tweets("#JustStopOil", n  = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_2_02122022, "data_frame_2_02122022.xlsx")

#0412022
data_frame_04122022 <- rtweet::search_tweets("Just Stop Oil OR just stop oil OR climate activists", n  = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_04122022, "data_frame_04122022.xlsx")

#13122022
data_frame_13122022 <- rtweet::search_tweets("climate crisis OR climate activists", n  = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_13122022, "data_frame_13122022.xlsx")

data_frame_1_13122022 <- rtweet::search_tweets("Just Stop Oil OR just stop oil", n  = 20000, retryonratelimit = TRUE) #nolint
write_xlsx(data_frame_1_13122022, "data_frame_1_13122022.xlsx")
